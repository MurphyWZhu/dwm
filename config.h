...
static const char *roficmd[] = { "rofi", "-modi", "drun", "-show", "drun", "-theme", "/usr/share/rofi/themes/Pop-Dark.rasi", "-icon-theme", "Qogir", "-show-icons", "-font", "Sarasa Mono SC Italic 20", NULL };
...
static const char *lightup[] = { "/home/murphy/.config/muscript/lightup.sh", NULL };
